...
LICENSE="GPL-2"
SLOT="0"
KEYWORDS="alpha amd64 arm hppa ia64 ~mips ppc ppc64 sh sparc x86 ~x86-fbsd x86-fbsd"
...
src_prepare() {
	epatch "${FILESDIR}/patch-data_Makefile.in"
	epatch "${FILESDIR}/patch-src_polkitd_gposixsignal.c"
	epatch "${FILESDIR}/patch-src_polkitbackend_Makefile.in" 
	#epatch "${FILESDIR}/patch-src_programs_pkexec.c"
