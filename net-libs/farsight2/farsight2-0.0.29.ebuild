...
# $Header: /var/cvsroot/gentoo-x86/net-libs/farsight2/farsight2-0.0.29.ebuild,v 1.8 2012/05/05 02:54:28 jdhore Exp $
...
src_configure() {
	#epatch "${FILESDIR}/patch-transmitters_shm_fs-shm-transmitter.c"
	epatch "${FILESDIR}/patch-gst-libs_gst_farsight_fs-interfaces.c"
	epatch "${FILESDIR}/patch-transmitters_multicast_fs-multicast-transmitter.c"
	epatch "${FILESDIR}/patch-transmitters_rawudp_fs-rawudp-transmitter.c"
	epatch "${FILESDIR}/patch-transmitters_rawudp_fs-rawudp-transmitter.h"
